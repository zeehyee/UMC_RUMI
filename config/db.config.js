...
dotenv.config();  //프로젝트의 루트 디렉토리에 있는 .env 파일을 찾아내 사용할 수 있도록 세팅
...
export const pool = mysql.createPool({
    ...
    database: process.env.DB_TABLE || 'UMC_RUMI',  // 데이터베이스 이름
    password: process.env.DB_PASSWORD || 'wlgP9324!',  // 비밀번호
